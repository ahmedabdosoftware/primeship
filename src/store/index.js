  ...
  state: {
    ...
    lan: {
      Ar: {
        ...
        through: " خلالنا",
        throughContent: "  تقديم الخدمات التي تغطي معظم أنحاء مدن المملكة و تتميز بأعلى مستويات الجودة, الاستثمار في موظفينا ومنحهم الصلاحيات التي تساعدهم ويقومون بواجباتهم على أكمل وجه",
